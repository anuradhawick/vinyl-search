module vinyl-search/backend-go/records

go 1.25.0

require (
	github.com/D-Andreev/lambdamux v0.0.4
	github.com/aws/aws-lambda-go v1.54.0
	go.mongodb.org/mongo-driver/v2 v2.8.0
	vinyl-search/backend-go/common v0.0.0
)
...
replace vinyl-search/backend-go/common => ../common
